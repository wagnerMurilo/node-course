...
namo.addEventListener('submit', (e) => {
    ...
    if(namoMsg1.textContent === '')
    {
        ...
        }else if(0.6>randomNamo>0.4)
        {
            ...
            namoMsg2.textContent = 'Pau pra toda obra. Otimo pai, construiu uma casa para as filhas com as proprias maos, onde mantem elas trancadas. Ele tambem e pintor e tem um estilo de pintada unico. Tambem e artezao, mas perdeu o ar quando te viu e ficou com tezao.'
            namoImg.textContent =''
